    ...
    if (form) {
        form.addEventListener("submit", (e) => {
            ...
            if (cuenta && correo === cuenta.email && password === cuenta.pass) {
                if (rol === "admin") window.location.href = "src/modules/usuarios/admin.html";
                if (rol === "cajero") window.location.href = "src/modules/usuarios/cajeros.html";
                if (rol === "usuario") window.location.href = "src/modules/cartelera/cartelera.html";
            } else {
